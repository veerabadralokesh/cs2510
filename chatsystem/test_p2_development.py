...
IMAGE_NAME    = "cs2510_p2_development"
NETWORK_NAME  = "cs2510"
...
def init_containers():
    for i in range(1,NUM_SERVERS+1):
        cmd_str = "docker run -v {cwd}:/opt/docker/ --cap-add=NET_ADMIN --name {serv} --network {net} --ip {ip} {img} {cmd} {args}".format(cwd=os.getcwd(), serv=server_name(i), net=NETWORK_NAME,
